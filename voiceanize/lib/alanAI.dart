...
class AlanAI {
  ...
  void initAlanButton() async {
    AlanVoice.addButton("36e2d97001aae4fab5bf6e3fe4fb8e492e956eca572e1d8b807a3e2338fdd0dc/stage");
  ...
  void _handleCommand(Map<String, dynamic> command) async{
    switch(command['command']) { 
      ...
      case 'goBack':
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => ListHome(this)), (Route<dynamic> route) => false);
        break;

      //Add Item
      case 'addItem':
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => AddProduct(this)), (Route<dynamic> route) => false);
        break;
      case 'addName': 
      ...
      case 'previewItem': 
        ...
        if (item == null) {
          ...
          Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => PreviewProduct(item, this)), (Route<dynamic> route) => false);
        }
        break;
      case 'previewMode':
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => PreviewProduct(page.item, this)), (Route<dynamic> route) => false);
        break;
      ...
      case 'editItem':
        ...
        if (item == null) {
          ...
          Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => EditProduct(item, this)), (Route<dynamic> route) => false);
        }
        break;
      case 'editName':
        newItem.nameController.text = command['value'];
      ...
      case 'editSubmit':
        ...
        break;
      case 'editMode':
        Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => EditProduct(page.item, this)), (Route<dynamic> route) => false);
        break;
